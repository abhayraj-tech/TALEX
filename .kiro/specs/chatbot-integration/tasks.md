...
- [x] 1. Set up backend chat route module
...
- [x] 2. Backend unit and property tests
  - [x] 2.1 Set up test infrastructure
  ...
  - [x] 2.2 Write unit tests for `POST /api/chat`
  ...
  - [x] 2.3 Write unit tests for `POST /api/chat/upload`
    - Valid image upload → 200 with `{ filename, originalName, mimeType, size }`
    - File > 10 MB → 413 with `error` string
    - _Requirements: 6.6, 6.7_

  - [x] 2.4 Write unit tests for rate limiter
    - 101st request within 15-minute window → 429
    - _Requirements: 3.6_

  - [x] 2.5 Write property test — Property 6: Missing or empty message field returns 400
  ...
  - [x] 2.6 Write property test — Property 7: File size limit enforced at upload
  ...
  - [x] 2.7 Write property test — Property 8: API key absence returns 503 for any request
...
- [x] 4. Create chatbot widget CSS (`chatbot-widget.css`)
...
- [x] 5. Create chatbot widget JS (`chatbot-widget.js`)
  - [x] 5.1 Scaffold module and DOM injection
  ...
  - [x] 5.2 Implement panel toggle and keyboard navigation
  ...
  - [x] 5.3 Implement message rendering and welcome state
  ...
  - [x] 5.4 Implement `sendMessage()` with SSE streaming
  ...
  - [x] 5.6 Implement copy-to-clipboard and toast
  ...
  - [x] 5.7 Implement voice input (`toggleVoiceInput()`)
  ...
  - [x] 5.8 Implement file attachment
...
- [x] 6. Frontend property tests (jsdom)
  - [x] 6.1 Write property test — Property 1: Message submission grows history
  ...
  - [x] 6.2 Write property test — Property 2: Whitespace-only input is rejected
  ...
  - [x] 6.3 Write property test — Property 3: SSE token accumulation is monotonically growing
  ...
  - [x] 6.4 Write property test — Property 4: Control disabled state always matches streaming state
  ...
  - [x] 6.5 Write property test — Property 5: Clear chat resets to empty state
  ...
  - [x] 6.6 Write property test — Property 9: All interactive widget controls have aria-labels
  ...
  - [x] 6.7 Write property test — Property 10: File attachment is reflected in message history
...
- [x] 7. Wire widget into `dashboard.html`
